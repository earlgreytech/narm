...
pub fn test_signextend_positive() {
    ...
    // 0: SXTB <Rd>,<Rm> T1
    create_vm!( arrays = (vms, vm_states), op_id = 0, asm_literal_add_svc = "sxtb r0, r1" );
    vm_states[0].r[0] = Some(0x54);
    
    // 1: SXTH <Rd>,<Rm> T1
    create_vm!( arrays = (vms, vm_states), op_id = 1, asm_literal_add_svc = "sxth r0, r1" );
    vm_states[1].r[0] = Some(0x7654);
    
    // 2: UXTB <Rd>,<Rm> T1
    create_vm!( arrays = (vms, vm_states), op_id = 2, asm_literal_add_svc = "uxtb r0, r1" );
    vm_states[2].r[0] = Some(0x54);
    
    // 3: UXTH <Rd>,<Rm> T1
    create_vm!( arrays = (vms, vm_states), op_id = 3, asm_literal_add_svc = "uxth r0, r1" );
